        ...
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex flex-col">
            ...
            <div className="text-xs sm:text-sm text-slate-600">
              created by{' '}
              <a href="https://x.com/0xMelkoreth" target="_blank" rel="noreferrer noopener" className="text-brand hover:text-brandDark font-semibold hover:underline">Melkor.eth</a>
            </div>
          </div>
